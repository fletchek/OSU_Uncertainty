...
dataList <- list(
  ...
  d = cmat_accuracy$resp_FH, c = cmat_accuracy$resp_HH,
  d_M = mean(cmat_accuracy$resp_FH), d_SD = sd(cmat_accuracy$resp_FH),
  c_M = mean(cmat_accuracy$resp_HH), c_SD = sd(cmat_accuracy$resp_HH)#,
)
