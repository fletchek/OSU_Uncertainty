...
dataList <- list(
  ...
  d = cmat_accuracy$resp_acc, c = cmat_accuracy$norm_dif,
  d_M = mean(cmat_accuracy$resp_acc), d_SD = sd(cmat_accuracy$resp_acc),
  c_M = mean(cmat_accuracy$norm_dif), c_SD = sd(cmat_accuracy$norm_dif)#,
)
